...
class EstablishmentsControllerTest < ActionController::TestCase
  ...
  test "should create establishment" do
    assert_difference('Establishment.count') do
      post :create, establishment: { address: @establishment.address, avatar: @establishment.avatar, city: @establishment.city, creation: @establishment.creation, name: @establishment.name, neighborhood: @establishment.neighborhood, state: @establishment.state, status: @establishment.status, zipcode: @establishment.zipcode }
    end
  ...
  test "should update establishment" do
    patch :update, id: @establishment, establishment: { address: @establishment.address, avatar: @establishment.avatar, city: @establishment.city, creation: @establishment.creation, name: @establishment.name, neighborhood: @establishment.neighborhood, state: @establishment.state, status: @establishment.status, zipcode: @establishment.zipcode }
    assert_redirected_to establishment_path(assigns(:establishment))
  end
